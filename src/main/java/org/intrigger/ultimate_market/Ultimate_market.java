...
public final class Ultimate_market extends JavaPlugin {
    ...
    /*
    * - TODO Добавить автосдачу на поставки. При нажатии кнопки игрок сдает весь инвентарь на самые выгодные для
    *     каждого из предметов поставки, если такие есть
    * - TODO Добавить поиск поставок на нужный товар
    * [V] Убрать возможность сдавать в поставках самому себе
    * [V] Убрать закончившиеся поставки из списка
    * [V] Добавить навигацию (страница прокрутки и обновление) для поставок
    * [X] Добавить нормальную систему RGB-цветов в файлах
    * [X] Ограничить группы макс. кол-вом поставок
    * [X] Добавить иконку описания для Основного меню и для поставок с информацией о том как пользоваться
    * [X] Добавить в лор Сдать 1 стак, сдать все
    */
